...
public class ShopProducts extends RecyclerView.Adapter<ShopProducts.ViewHolder> {

    Context ctx;
    ArrayList<ShopProductModel> productModels;
    private ArrayList<ShopProductModel> arraylist;

    public ShopProducts(ArrayList<ShopProductModel> arrayList, Context ctx) {
        this.ctx = ctx;
    ...
    @NonNull
    @Override
    public ShopProducts.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull ShopProducts.ViewHolder holder, final int position) {
        ...
        if (productModels.get(position).getStock().equals("0")) {
            ...
            holder.notify_product.setVisibility(View.VISIBLE);
            ...
            holder.notify_product.setVisibility(View.GONE);
        ...
        holder.notify_product.setOnClickListener(view -> {
            notify_product(productModels.get(position).getProductId());
        });
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView productName, productPrice, ProductNetPrice, product_price_single, out_of_stock,notify_product;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            notify_product = itemView.findViewById(R.id.notify_product);
    ...
    public void notify_product(String productId) {
        ...
        Call<JsonArray> call = getDataServices.notify_product("notify_product", SharedPrefManager.getInstance(ctx).getUser().getId(), productId);
            ...
            public void onResponse(Call<JsonArray> call, Response<JsonArray> response) {
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("success")) {
                        TastyToast.makeText(ctx, jsonObject.getString("msg"), TastyToast.LENGTH_LONG, TastyToast.SUCCESS).show();
                    } else {
                        TastyToast.makeText(ctx, jsonObject.getString("msg"), TastyToast.LENGTH_LONG, TastyToast.SUCCESS).show();
